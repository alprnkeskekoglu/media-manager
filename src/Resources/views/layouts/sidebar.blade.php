        ...
        <div class="content-side">
            <ul class="nav-main">
                <li class="nav-main-item mb-3">
                    <a class="nav-main-link {{ $type == 'upload' ? 'active' : '' }}" id="createBtn" href="{{ route('dawnstar.filemanager.upload', ['selectableType' => $selectableType , 'maxMediaCount' => $maxMediaCount]) }}">
                        <i class="nav-main-link-icon fa fa-plus"></i>
                        <span class="nav-main-link-name">{{ __('FileManagerLang::general.sidebar.upload') }}</span>
                    </a>
                </li>
                <li class="nav-main-item">
                    <a class="nav-main-link {{ $type == 'all' ? 'active' : '' }}" id="indexBtn" href="{{ route('dawnstar.filemanager.index', ['selectableType' => $selectableType , 'maxMediaCount' => $maxMediaCount]) }}">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link {{ $type == 'image' ? 'active' : '' }}" href="{{ $imageCount > 0 ? route('dawnstar.filemanager.index', ['type' => 'image', 'selectableType' => $selectableType , 'maxMediaCount' => $maxMediaCount]) : 'javascript:void(0);' }}">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link {{ $type == 'file' ? 'active' : '' }}" href="{{ $fileCount > 0 ? route('dawnstar.filemanager.index', ['type' => 'file', 'selectableType' => $selectableType , 'maxMediaCount' => $maxMediaCount]) : 'javascript:void(0);' }}">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link {{ $type == 'video' ? 'active' : '' }}" href="{{ $videoCount > 0 ? route('dawnstar.filemanager.index', ['type' => 'video', 'selectableType' => $selectableType , 'maxMediaCount' => $maxMediaCount]) : 'javascript:void(0);' }}">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link {{ $type == 'audio' ? 'active' : '' }}" href="{{ $audioCount > 0 ? route('dawnstar.filemanager.index', ['type' => 'audio', 'selectableType' => $selectableType , 'maxMediaCount' => $maxMediaCount]) : 'javascript:void(0);' }}">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link {{ $type == 'trash' ? 'active' : '' }}" href="{{ $trashedCount > 0 ? route('dawnstar.filemanager.index', ['type' => 'trash', 'selectableType' => $selectableType , 'maxMediaCount' => $maxMediaCount]) : 'javascript:void(0)' }}">
